...
<body class="ml-3 mt-5">
    ...
    <a class="btn btn-danger" href="index.php">Back to Home</a><br><br>

    <form action="manager/add_product_manager.php" method="post">
        <div id="div_add_a_product" class="col-md-4" style="display: none;">
            <fieldset class="border p-2">
                <legend class="w-auto">Product info:</legend>
                <label for="item_name" class="form-info">Item Name:</label>
                ...
                <input type="text" name="item_description" placeholder="Item description" class="form-control"><br>
                <br><label for="item_price" class="form-info">Item Price:</label>
                <input type="number" step="0.01" name="item_price" placeholder="Item Name" class="form-control"><br>
                ...
                <br><label for="item_category" class="form-info">Category:</label>
                ...
                <input type="submit" class="btn btn-primary" value="Add to product list">
            </fieldset>
        </div>
    </form>
</body>
